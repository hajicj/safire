#!/usr/bin/env python
"""
``run_t2i.py`` is a script that runs a trained text-image system.
...
run_t2i.py -t .NAV.pf0.2.pff.tfidf .RSM-2000 .RBM-1000 -i . .DA-1000 -j .RBM-1000
...
def main(args):
    logging.info('Executing run_t2i.py...')
    ...
    if args.baseline:
        ...
        logging.info('Exiting run_t2i.py, baseline.')
        return
    ...
    logging.info('Exiting run_t2i.py.')
